...
var object_template = {
	...
	"distribution box": {
		"lex200": Vector2(15, 12),
		"lex800": Vector2(15, 12),
		"lex1200": Vector2(18, 15),
	}
}
...
func new_object_pressed(category: String, obj_type: String) -> bool:
	...
	new_object.set_object_name(obj_type)
	new_object.set_object_power(0)
	new_object.set_num_sections(num_sections)
