...
@onready var camp_cad_2 = $"MarginContainer/HBoxContainer/Calculator Window/Panel/MarginContainer/Camp Cad2"


@onready var calculators = [ohm_law_calc, pythagore, test_1, camp_electrical_calculator, settings, camp_cad_2]
...
func _on_camp_cad_v_2_pressed():
	set_state(camp_cad_2)
